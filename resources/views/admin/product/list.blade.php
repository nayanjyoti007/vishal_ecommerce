        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <a href="{{ route('admin.product.form') }}" class="btn btn-sm btn-success">Add Product</a>
                        </div>
                            ...
                            <tbody>
                                @forelse ($product as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->slug }}</td>
                                        <td>
                                            <a href="{{ route('admin.product.form', ['id' => $item->id]) }}"
                                                class="btn btn-primary btn-sm">Edit</a>

                                            @if ($item->status == 1)
                                                <a href="{{ route('admin.product.status', ['id' => $item->id]) }}"
