                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('admin.dashboard')}}" class="waves-effect @yield('dashboard_active')">
                            ...
                            <li>
                                <a href="{{route('admin.coupon.list')}}" class=" waves-effect @yield('coupon_active')">
                            ...
                            <li>
                                <a href="{{route('admin.size.list')}}" class=" waves-effect @yield('size_active')">
