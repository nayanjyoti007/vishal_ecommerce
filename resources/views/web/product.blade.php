                        ...
                        <div class="prt_02 mb-3">
                            ...
                            <div class="text-left">
                                ...
                                <div class="elis_rty">
                                    ...
                                    {{-- <span class="ft-regular text-danger bg-light-danger py-1 px-2 fs-sm">Out of Stock</span></div> --}}
                                </div>
                            </div>
                                        ...
                                        @if ($itemColor->color != null)
                                            <div class="form-check form-option form-check-inline mb-1">
                                                <input class="form-check-input" type="radio" name="color"
                                                    id="{{ $itemColor->color_id }}" value="{{ $itemColor->color_id }}">
                                                <label class="form-option-label rounded-circle"
                                                    for="{{ $itemColor->color_id }}"><span
                            ...
                            <div class="prt_04 mb-4">
                                ...
                                <div class="text-left pb-0 pt-2">
                                    ...
                                    @forelse ($result['product_attributes'] as $itemSize)
                                        @if ($itemSize->color != null)
                                            <div class="form-check size-option form-option form-check-inline mb-2">
                                                <input class="form-check-input" type="radio" name="size"
                                                    id="{{ $itemSize->size_id }}" value="{{ $itemSize->size_id }}">
                                                <label class="form-option-label"
                                                    for="{{ $itemSize->size_id }}">{{ $itemSize->size }}</label>
                                            </div>
                                        @endif
                                    @empty
                                    @endforelse
