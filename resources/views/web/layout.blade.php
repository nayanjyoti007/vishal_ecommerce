...
<head>
    ...
    <title>Fashion eCommerce | @yield('page_title')</title>
    @yield('head')
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 hide-ipad">
                        <div class="top_first"><a href="callto:(+84)0123456789" class="medium text-muted">(+84) 0123 456
                                789</a></div>
                    </div>

                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 hide-ipad">
                        <div class="top_second text-center">
                            <p class="medium text-muted m-0 p-0">Get Free delivery from ₹2000 <a
                                    href="javascript:void(0)" class="medium text-dark text-underline">Shop Now</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12">
                        ...
                        <div class="currency-selector dropdown js-dropdown float-right">
                            ...
                            <ul class="popup-content dropdown-menu">
                                <li><a title="Euro" href="javascript:void(0)"
                                        class="dropdown-item medium text-muted">EUR €</a></li>
                                <li class="current"><a title="US Dollar" href="javascript:void(0)"
         ...
         <ul class="nav-dropdown nav-submenu">
          ...
          <li><a href="faq.html">FAQs</a></li>
                            ...
                            <li><a href="javascript:void(0);">Product</a>
                                <ul class="nav-dropdown nav-submenu">
                                    <li><a href="javascript:void(0)">Product Detail v01</a></li>
                                    <li><a href="javascript:void(0)">Product Detail v02</a></li>
                                    <li><a href="javascript:void(0)">Product Detail v03</a></li>
                                    <li><a href="javascript:void(0)">Product Detail v04</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="openCart()">
                                    <i class="lni lni-shopping-basket"></i><span
                                        class="dn-counter bg-warning">3</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                            <div class="footer_widget">
                                ...
                                <div class="address mt-3">
                                    ...
                                    <div class="scr_payment"><img src="{{ asset('frontend/assets/img/card.png') }}"
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12 text-center">
                            <p class="mb-0">© 2023 Kumo. Designd By <a
                                    href="https://pakhiinfotech.in/">Nayanjyoti</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="quick_view_wrap">
                            ...
                            <div class="quick_view_thmb">
                                <div class="quick_view_slide">
                                    <div class="single_view_slide"><img
                                            src="{{ asset('frontend/assets/img/product/1.jpg') }}" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('frontend/assets/img/product/2.jpg') }}" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('frontend/assets/img/product/3.jpg') }}" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('frontend/assets/img/product/4.jpg') }}" class="img-fluid"
                                            alt="" /></div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body p-5">
                        ...
                        <form>
                            ...
                            <div class="form-group text-center mb-0">
                                <p class="extra">Not a member?<a href="javascript:void(0)et-register-wrap"
                                ...
                                <div class="sl_cat_01">
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/tshirt.png') }}" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/pant.png') }}" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/fashion.png') }}"
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/sneakers.png') }}"
                                                class="img-fluid" width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/television.png') }}"
                                                class="img-fluid" width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('frontend/assets/img/accessories.png') }}"
                                                class="img-fluid" width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                    ...
                    <div class="cart_select_items py-2">
                            ...
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('frontend/assets/img/product/4.jpg') }}" width="60"
                        ...
                        <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('frontend/assets/img/product/7.jpg') }}" width="60"
                                            class="img-fluid" alt="" /></a>
                                </div>
                                <div class="cart_single_caption pl-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('frontend/assets/img/product/8.jpg') }}" width="60"
                                            class="img-fluid" alt="" /></a>
                                </div>
                                <div class="cart_single_caption pl-2">
